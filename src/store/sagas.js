...
function* api_v1_gghmjhgjhg_listWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gghmjhgjhg_list, action)
    yield put(actions.api_v1_gghmjhgjhg_listSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_listFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_listWatcher() {
  yield takeEvery(types.API_V1_GGHMJHGJHG_LIST, api_v1_gghmjhgjhg_listWorker)
}
function* api_v1_gghmjhgjhg_createWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gghmjhgjhg_create, action)
    yield put(actions.api_v1_gghmjhgjhg_createSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_createFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_createWatcher() {
  yield takeEvery(
    types.API_V1_GGHMJHGJHG_CREATE,
    api_v1_gghmjhgjhg_createWorker
  )
}
function* api_v1_gghmjhgjhg_readWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gghmjhgjhg_read, action)
    yield put(actions.api_v1_gghmjhgjhg_readSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_readFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_readWatcher() {
  yield takeEvery(types.API_V1_GGHMJHGJHG_READ, api_v1_gghmjhgjhg_readWorker)
}
function* api_v1_gghmjhgjhg_updateWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gghmjhgjhg_update, action)
    yield put(actions.api_v1_gghmjhgjhg_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_updateFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_updateWatcher() {
  yield takeEvery(
    types.API_V1_GGHMJHGJHG_UPDATE,
    api_v1_gghmjhgjhg_updateWorker
  )
}
function* api_v1_gghmjhgjhg_partial_updateWorker(action) {
  try {
    const result = yield call(
      apiService.api_v1_gghmjhgjhg_partial_update,
      action
    )
    yield put(actions.api_v1_gghmjhgjhg_partial_updateSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_partial_updateFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_partial_updateWatcher() {
  yield takeEvery(
    types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE,
    api_v1_gghmjhgjhg_partial_updateWorker
  )
}
function* api_v1_gghmjhgjhg_deleteWorker(action) {
  try {
    const result = yield call(apiService.api_v1_gghmjhgjhg_delete, action)
    yield put(actions.api_v1_gghmjhgjhg_deleteSucceeded(result, action))
  } catch (err) {
    yield put(actions.api_v1_gghmjhgjhg_deleteFailed(err, action))
  }
}
function* api_v1_gghmjhgjhg_deleteWatcher() {
  yield takeEvery(
    types.API_V1_GGHMJHGJHG_DELETE,
    api_v1_gghmjhgjhg_deleteWorker
  )
}
...
export default function* rootSaga() {
  const sagas = [
    ...
    api_v1_gghmjhgjhg_listWatcher,
    api_v1_gghmjhgjhg_createWatcher,
    api_v1_gghmjhgjhg_readWatcher,
    api_v1_gghmjhgjhg_updateWatcher,
    api_v1_gghmjhgjhg_partial_updateWatcher,
    api_v1_gghmjhgjhg_deleteWatcher,
