...
const initialState = { mobileeocttAPI: [] }
  ...
  switch (action.type) {
    ...
    case types.API_V1_CUSTOMTEXT_LIST_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    ...
    case types.API_V1_GGHMJHGJHG_LIST:
    case types.API_V1_GGHMJHGJHG_LIST_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_LIST_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    case types.API_V1_GGHMJHGJHG_CREATE:
    case types.API_V1_GGHMJHGJHG_CREATE_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_CREATE_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    case types.API_V1_GGHMJHGJHG_READ:
    case types.API_V1_GGHMJHGJHG_READ_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_READ_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    case types.API_V1_GGHMJHGJHG_UPDATE:
    case types.API_V1_GGHMJHGJHG_UPDATE_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    case types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE:
    case types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
    case types.API_V1_GGHMJHGJHG_DELETE:
    case types.API_V1_GGHMJHGJHG_DELETE_SUCCEEDED:
    case types.API_V1_GGHMJHGJHG_DELETE_FAILED:
      return Object.assign({}, state, {
        mobileeocttAPI: [...state.mobileeocttAPI, action.response]
      })
