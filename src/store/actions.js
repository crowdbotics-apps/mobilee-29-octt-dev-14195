...
export const api_v1_gghmjhgjhg_list = () => ({
  type: types.API_V1_GGHMJHGJHG_LIST
})
export const api_v1_gghmjhgjhg_listSucceeded = (response, starter) => ({
  type: types.API_V1_GGHMJHGJHG_LIST_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_listFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_LIST_FAILED,
  error,
  starter
})
export const api_v1_gghmjhgjhg_create = data => ({
  type: types.API_V1_GGHMJHGJHG_CREATE,
  data
})
export const api_v1_gghmjhgjhg_createSucceeded = (response, starter) => ({
  type: types.API_V1_GGHMJHGJHG_CREATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_createFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_CREATE_FAILED,
  error,
  starter
})
export const api_v1_gghmjhgjhg_read = () => ({
  type: types.API_V1_GGHMJHGJHG_READ
})
export const api_v1_gghmjhgjhg_readSucceeded = (response, starter) => ({
  type: types.API_V1_GGHMJHGJHG_READ_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_readFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_READ_FAILED,
  error,
  starter
})
export const api_v1_gghmjhgjhg_update = data => ({
  type: types.API_V1_GGHMJHGJHG_UPDATE,
  data
})
export const api_v1_gghmjhgjhg_updateSucceeded = (response, starter) => ({
  type: types.API_V1_GGHMJHGJHG_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_updateFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_gghmjhgjhg_partial_update = data => ({
  type: types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE,
  data
})
export const api_v1_gghmjhgjhg_partial_updateSucceeded = (
  response,
  starter
) => ({
  type: types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_partial_updateFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_PARTIAL_UPDATE_FAILED,
  error,
  starter
})
export const api_v1_gghmjhgjhg_delete = () => ({
  type: types.API_V1_GGHMJHGJHG_DELETE
})
export const api_v1_gghmjhgjhg_deleteSucceeded = (response, starter) => ({
  type: types.API_V1_GGHMJHGJHG_DELETE_SUCCEEDED,
  response,
  starter
})
export const api_v1_gghmjhgjhg_deleteFailed = (error, starter) => ({
  type: types.API_V1_GGHMJHGJHG_DELETE_FAILED,
  error,
  starter
})
